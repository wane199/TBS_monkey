...
For detailed instructions regarding the elsevier article class, see[@global;@china]   <https://www.elsevier.com/authors/policies-and-guidelines/latex-instructions>

# Bibliography styles

Here[@extra;@deep] are two sample references: @Feynman1963118.

By default, natbib will be used with the `authoryear` style[@extra], set in `classoption` variable in YAML @extra. 
