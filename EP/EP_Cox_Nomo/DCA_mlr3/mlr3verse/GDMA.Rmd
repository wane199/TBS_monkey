...
Explainable machine learning/AI techniques(aka XAI):
- 本实验基于真实的心脏病患者体侧数据，介绍如何通过数据挖掘算法构建心脏病预测模型。然而，本案例的目标不仅限于此——
本案例着重分析机器学习模型的可解释性。

```{r echo=FALSE, out.width=c("40%","25%")}
knitr::include_graphics(c("images/QR_code.png"))
```
...
knitr::include_graphics(path = "images/xai.png")
```
Learning Performance Versus Explainability Trade-Off for Several Categories of Learning Techniques[@gunning2019darpa]
