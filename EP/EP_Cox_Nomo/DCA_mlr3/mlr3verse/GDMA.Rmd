...
```{r echo=FALSE, out.width=c("70%", "80%"),fig.cap="Focuses on interpretability of ML"}
...
```{r echo=FALSE, out.width=c("80%"),fig.align="center", fig.cap="PDP plot of AI_radscore"}
knitr::include_graphics("images/PDP_ai.png")
``` 
...
- Metabolic radiomics are helpful to predict the post-surgical seizure outcomes;
- Combination of PET Radiomics and Clinical Features are more robust;
- IML technique can further deepen the understanding of the principle of machine learning model and the decision-making process for professional and intuitive interpretation
