...
name: MRIneg
## Second
98例MRIneg数据集(3 ~ 55 y, 21.0 y, 21.92 ± 10.54 y)年龄分层，38例儿童患者(38.8%，3 ~ 17 y, 13.21 y, 12.27 ± 3.74 y); [vs.TLE](#TLE-Child)
...
name: TLE-Child
## Third
234例颞叶癫痫数据集(3~60 y, 23.5 y, 25.50 ± 8.89 y)年龄分层，31例儿童患者(13.2%，3~17 y, 15.0 y, 13.92 ± 2.95 y);[Back MRIneg](#MRIneg)
```{r echo=FALSE,out.width="90%"}
