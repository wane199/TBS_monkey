...
df1 <- read_excel('C:\\Users\\wane1\\Documents\\LYX\\excel\\_全身.xlsx')
df2 <- read_excel('C:\\Users\\wane1\\Documents\\LYX\\excel\\2021_全身.xlsx')
df3 <- read_excel('C:\\Users\\wane1\\Documents\\LYX\\excel\\d_全身.xlsx')
df4 <- read_excel('C:\\Users\\wane1\\Documents\\LYX\\excel\\病人_全身.xlsx')
total <- rbind(df1,df2,df3,df4) 
df0 <- base::unique(total)
write_excel_csv(df, file = "C:\\Users\\wane1\\Documents\\LYX\\csv\\全身.csv")
df0 <- read.csv('C:\\Users\\wane1\\Documents\\LYX\\csv\\全身0.csv')
...
write_excel_csv(df11, file = "C:\\Users\\wane1\\Documents\\LYX\\csv\\股骨_side.csv")
# 
...
df1 <- read_excel('C:\\Users\\wane1\\Documents\\LYX\\excel\\_正位脊柱.xlsx')
# df3 <- read_excel('C:\\Users\\wane1\\Documents\\LYX\\excel\\2021_AHA.xlsx')
df2 <- read.csv('C:\\Users\\wane1\\Documents\\LYX\\csv\\2017_AHA_side.csv')
df3 <- read.csv('C:\\Users\\wane1\\Documents\\LYX\\csv\\2021_AHA_side.csv')
dim(df1)
head(df2)
str(df1)
df1 <- base::unique(df1) 
...
df_12 <- merge(df2, df3, by = c('姓','病人ID.','性别','年龄'))
df_12 <- base::unique(df_12) 
...
df_36 <- merge(df3,df6,by = c('姓','性别','年龄')) # , all = TRUE
df_45 <- merge(df4,df5,by = c('姓','性别','年龄')) # , all = TRUE

df_16 <- merge(df_12, df_36, by = c('姓','性别','年龄'))  # , incomparables = NA
df_1_6 <- merge(df_16, df_45, by = c('姓','性别','年龄'), all = TRUE
)

df_1_6 <- base::unique(df_1_6) 
write_excel_csv(df_1_6, file = "C:\\Users\\wane1\\Documents\\LYX\\csv\\_股骨-_全身.csv")
